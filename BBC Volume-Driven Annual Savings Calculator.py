...
st.markdown(
    '<p style="font-size:25px; margin: 0; line-height:1.1;">Enter the quantity of loader workers:</p>',
    unsafe_allow_html=True
)
loader_qty = st.number_input("", min_value=0, step=1, format="%d", key="loader_input")

st.markdown(
    '<p style="font-size:25px; margin: 0; line-height: 1.1;">Enter the quantity of HGV driver workers:</p>',
    unsafe_allow_html=True
)
